...
class Model_Photographers extends CI_Model {

    public function __construct() {
        parent::__construct();
    }

    public function insertPhotography(){
        ...
        $data[DBConfig::TABLE_EVENT_ATT_CATEGORY_ID] = '5';
        ...
        if($insert) {
            redirect(site_url(SiteConfig::CONTROLLER_PHOTOGRAPHERS.SiteConfig::METHOD_PHOTOGRAPHERS_PHOTOGRAPHY.'/'.$eventId));
        }
    }
