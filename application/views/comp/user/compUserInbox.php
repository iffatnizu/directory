    ...
    <script type="text/javascript">
        $(document).ready(function(){
            setInterval(function(){
                if(isUserClick==true)
                {
                    directory.intervalForLoadUserMessage();    
                }
            },7000)
        })
    </script>
    <div>
        <h2><i class="icon-envelope"></i> <?php echo $title; ?></h2>
            ...
            <ul>
                ...
                foreach ($allmessage as $msg) {
                    ...
                    <li id="pmid_<?php echo cpr_encode($msg[DBConfig::TABLE_EVENT_MESSAGE_ATT_EVENT_INFO_ID]) ?>">
                        <a id="pmaid_<?php echo cpr_encode($msg[DBConfig::TABLE_EVENT_MESSAGE_ATT_EVENT_INFO_ID]) ?>" class="pm_<?php echo $i; ?>" href="javascript:;" onclick="directory.getUserMessageById('<?php echo cpr_encode($msg[DBConfig::TABLE_EVENT_MESSAGE_ATT_EVENT_INFO_ID]) ?>')">
                            <i class="icon-user"></i>
                            <h6><?php echo $msg[DBConfig::TABLE_EVENT_MESSAGE_ATT_MESSAGE_TITLE] ?></h6>
                            <p>
                                <?php echo $msg[DBConfig::TABLE_EVENT_INFO_ATT_EVENT_NAME] ?><br clear="all"/>

                                <small>
                                    From : <?php echo $msg[DBConfig::TABLE_VENDOR_ATT_VENDOR_NAME] ?><br/>
