<div id=main role=main>
    <div id=main-content>
        ...
        if ($this->session->userdata('_success')) {
            echo '<p style="text-indent:12px;" class="btn-success">Site information successfully updated</p>';
        }
                ...
                <div class=block-border>
                    <div class=block-content>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Home Content Status</td>
                                <td>
                                    <input type="radio" name="homeContentStatus" <?php echo ($details[Dbconfig::TABLE_SETTINGS_ATT_HIDE_HOME_CONTENT] == '0') ? 'checked=""':''; ?> value="0"/> Hide
                                    <input type="radio" name="homeContentStatus" <?php echo ($details[Dbconfig::TABLE_SETTINGS_ATT_HIDE_HOME_CONTENT] == '1') ? 'checked=""':''; ?> value="1"/> Show
                                    <?php echo form_error('homeContentStatus'); ?>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
